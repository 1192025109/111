...
def get_args():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default=r'E:\WORK\VideoMAE-main\VideoMAE-main\data', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default=r'E:\WORK\VideoMAE-main\VideoMAE-main\ssv2',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default=r"E:\WORK\VideoMAE-main\VideoMAE-main\ssv2",
